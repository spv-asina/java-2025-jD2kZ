...
class Exmaple4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("ЗАДАЧА: Получить топ-2 студента по средней оценке выше 4 по группам, \n" +
                "        преобразовать имена в верхний регистр, \n" +
                "        отсортировать по имени в обратном порядке");

        Map<String, List<String>> result = students.stream()
                .filter(s -> s.grade >= 4.0)
                ...
                .collect(Collectors.groupingBy(
                                ...
                                Collectors.collectingAndThen(
                                        ...
                                        list -> list.stream()
                                                ...
                                                .sorted(Comparator.reverseOrder())                      // сортировка по имени
